...
- name: Global Change Information System API List regions.
  ...
  baseURL: https://data.globalchange.gov////region
  tags: Regions
  properties:
...
- name: Global Change Information System API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/regions/master/_listings/globalchange-gov/openapi.md
x-common:
- type: x-developer
